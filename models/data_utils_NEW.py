...
def add_label_token_bert(model, tokenizer, procotol, label_map_path, handmade_lmp, tag2index):
...
def bert_sequences(X, y, max_chunks, max_tokens, id2word, tokenizer, tag2index, id2tag):
